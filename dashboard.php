		...
		<div class="badan">
            ...
            <!-- <?php echo substr("hello", 0, 4) ?> -->
              ...
              <tr>
                <td><?= $i;  ?></td>
                <td>
                  <a href="ubah_berita.php?ID=<?= $row["ID"];?>"><i class="fa fa-pencil fa-fw"></i></a> |
                  <a href="hapus_berita.php?ID=<?= $row["ID"];?>" onclick="return confirm('Yakin Ingin Dihapus?');"><i class="fa fa-trash fa-fw"></i></a> |
									<a href="cek_berita.php?ID=<?= $row["ID"];?>"><i class="fa fa-info-circle fa-fw"></i></a>
                </td>
                <td><?= substr($row["Judul"],0, 5);?></td>
                <td><?= substr($row["Penulis"],5, 10);  ?></td>
